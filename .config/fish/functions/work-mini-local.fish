# ABOUTME: Mosh into the mini dev server via local network and run utm.
# ABOUTME: Usage: work-mini-local [host] (defaults to mini-dylan.local)

function work-mini-local --description "mosh into mini (local) and run utm"
    set -l host mini-dylan.local
